...
extern int sudo_askpass_mode;          /* -A: use askpass helper */
extern int sudo_background_mode;       /* -b: run in background */
extern int sudo_bell_mode;             /* -B: ring bell when prompting */
extern int sudo_edit_mode;             /* -e: edit files instead of running command */
extern int sudo_login_mode;            /* -i: run login shell */
extern int sudo_reset_timestamp;       /* -k: reset timestamp */
extern int sudo_remove_timestamp;      /* -K: remove timestamp completely */
extern int sudo_non_interactive;       /* -n: non-interactive mode */
extern int sudo_stdin_password;        /* -S: read password from stdin */
extern int sudo_shell_mode;            /* -s: run shell */
extern int sudo_validate_only;         /* -v: validate user's timestamp */
extern char *sudo_chroot_dir;          /* -R: chroot directory */
extern int sudo_command_timeout;       /* -T: command timeout in seconds */
...
#define AUTH_METHOD_STANDARD 0
#define AUTH_METHOD_ASKPASS 1
#define AUTH_METHOD_STDIN 2
...
/* Shell access control functions */
